          ...
          <div className="bento-card border-l-4 border-l-primary-500 animate-scale-in">
            ...
            <div className="space-y-4 mb-4">
              {exceptions.map((rule, index) => (
                <div key={rule.id} className="bg-primary-50 p-4 rounded-2xl border border-primary-200">
                  <div className="flex justify-between items-center mb-2">
                    <span className="font-medium font-chinese text-primary-800">{rule.name}</span>
            ...
            <div className="bg-primary-50 p-4 rounded-2xl border border-primary-200">
              <h4 className="text-primary-800 font-chinese mb-3">
              ...
              <div className="space-y-3">
                <input
                  ...
                  placeholder="规则名称"
                  className="w-full bg-white border border-primary-200 rounded-2xl px-4 py-2 text-[#161615] font-chinese"
                />
                <div className="flex justify-end space-x-2">
                  ...
                  <button
                    ...
                    className="px-4 py-2 bg-primary-500 text-white rounded-2xl font-chinese hover:bg-primary-600 transition-colors"
                  >
